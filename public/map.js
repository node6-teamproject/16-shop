        ...
        this.regions = [
            ...
            { 
                ...
                specialties: [
                    ...
                    { name: '청주 직지', lat: 36.6424, lng: 127.4890 },
                    { name: '보은 대추', lat: 36.4894, lng: 127.7292 },
                    { name: '영동 포도', lat: 36.1746, lng: 127.7831 },
                    { name: '괴산 고추', lat: 36.8150, lng: 127.7868 }
                ]
            },
            { 
                name: '충청남도', 
            ...
            { 
                ...
                specialties: [
                    ...
                    { name: '고창 복분자', lat: 35.4358, lng: 126.7020 },
                    { name: '임실 치즈', lat: 35.6178, lng: 127.2792 },
                    { name: '남원 추어탕', lat: 35.4164, lng: 127.3906 },
                    { name: '전주 비빔밥', lat: 35.8242, lng: 127.1480 }
                ]
            },
            { 
                name: '전라남도', 
                ...
                specialties: [
                    ...
                    { name: '영광 굴비', lat: 35.2775, lng: 126.5120 },
            ...
            { 
                ...
                lng: 126.5534, 
                specialties: [
                    { name: '제주 감귤', lat: 33.2500, lng: 126.4000 },
                    { name: '제주 흑돼지', lat: 33.4000, lng: 126.5400 },
                    { name: '제주 한라봉', lat: 33.3600, lng: 126.7000 },
                    { name: '제주 옥돔', lat: 33.5100, lng: 126.5100 },
                    { name: '제주 녹차', lat: 33.3000, lng: 126.2900 }
                ]
            }
        ];
